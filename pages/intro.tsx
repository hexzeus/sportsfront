    ...
    return (
        <div className="fixed inset-0 z-50 bg-black flex items-center justify-center overflow-hidden">
            <div className="absolute inset-0 flex justify-center items-center overflow-hidden">
                ...
                <div className="absolute w-96 h-96 rounded-full bg-red-900 opacity-20 blur-3xl animate-pulse"></div>
            ...
            <div className="relative z-10 text-center space-y-8 transform transition-all duration-1000 ease-out">
                <div className="flex justify-center space-x-8 mb-8">
                    ...
                    <Target className="w-16 h-16 text-red-600 animate-pulse delay-200" />
                    <Trophy className="w-16 h-16 text-gray-300 animate-pulse delay-300" />
                </div>

                <h1 className="text-6xl md:text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-gray-300 to-red-600 mt-4 animate-pulse uppercase tracking-widest drop-shadow-xl">
                ...
                <div className="flex justify-center items-center space-x-6">
                    ...
                    <Flame className="w-12 h-12 text-red-600 animate-pulse delay-150" />
                    <Zap className="w-12 h-12 text-red-600 animate-pulse delay-300" />
                </div>

                <p className="text-xl md:text-3xl text-red-600 mt-8 tracking-wider font-mono font-bold opacity-90 animate-pulse">
                    Unleashing the Power of Sports Betting Mastery...
                </p>
            </div>

            <div className="absolute inset-0 z-[-1] overflow-hidden">
                <div className="absolute top-1/3 left-1/4 w-64 h-64 sm:w-72 sm:h-72 md:w-96 md:h-96 bg-gradient-to-r from-red-900 to-gray-800 rounded-full blur-3xl opacity-30 animate-pulse"></div>
                <div className="absolute bottom-1/3 right-1/4 w-64 h-64 sm:w-72 sm:h-72 md:w-96 md:h-96 bg-gradient-to-r from-gray-800 to-red-900 rounded-full blur-3xl opacity-30 animate-spin-slow"></div>
            </div>
