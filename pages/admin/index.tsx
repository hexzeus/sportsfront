...
function EditableBetItem({
    ...
    const [editableBet, setEditableBet] = useState<Bet>({
        ...
        amount: bet.amount || 0,
        odds: bet.odds || '', // Ensure odds are a string here
    ...
    return (
        <li className="p-6 bg-gray-900 rounded-lg shadow-lg border border-red-500 space-y-6">
            ...
            <div className="flex flex-col space-y-4 md:flex-row md:space-x-6 md:space-y-0">
                ...
                <button onClick={handleUpdate} className="bg-blue-500 text-white py-2 px-6 rounded-lg shadow-md hover:bg-blue-600 text-sm">
                    Update Bet
                </button>
                <button onClick={handleDelete} className="bg-red-500 text-white py-2 px-6 rounded-lg shadow-md hover:bg-red-600 text-sm">
                    Delete Bet
                </button>
            </div>
        </li>
