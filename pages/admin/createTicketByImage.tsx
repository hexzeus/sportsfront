...
export default function CreateTicketByImage() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-black to-red-900 text-zinc-100 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto relative z-10">
                <motion.h1
                    className="text-4xl sm:text-5xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 mb-12"
                ...
                >
                    <div className="space-y-4">
                        <label htmlFor="team" className="block text-lg font-medium text-orange-400">Custom Tag for Admin Panel</label>
                        <input
                            id="team"
                            type="text"
                            value={team}
                            onChange={(e) => setTeam(e.target.value)}
                            className="block w-full p-4 bg-zinc-800 text-zinc-100 rounded-lg border border-red-700 focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition duration-300"
                    ...
                    <div className="space-y-4">
                        <label htmlFor="image-upload" className="block text-lg font-medium text-orange-400">Upload Image</label>
                        <div className="relative">
                            ...
                            <label
                                ...
                                className="flex items-center justify-center w-full p-4 bg-zinc-800 text-zinc-100 rounded-lg border border-red-700 cursor-pointer hover:bg-zinc-700 transition duration-300"
                            >
                    ...
                    <motion.button
                        type="submit"
                        className="w-full py-4 bg-gradient-to-r from-red-600 to-orange-600 text-zinc-100 text-lg font-bold rounded-lg shadow-xl hover:from-red-700 hover:to-orange-700 transition duration-300 flex items-center justify-center"
                ...
                >
                    <motion.button
                        ...
                        className="inline-flex items-center justify-center px-8 py-3 bg-gradient-to-r from-zinc-800 to-zinc-700 text-zinc-100 text-lg font-semibold rounded-full shadow-lg hover:from-zinc-700 hover:to-zinc-600 transition duration-300"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                    >
