    ...
    return (
        <Layout>
            <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-black via-gray-900 to-falcons-red text-white p-6 md:p-12">
                <div className="bg-gray-900 p-8 md:p-12 rounded-xl shadow-2xl max-w-3xl mx-auto transform transition-transform duration-500 hover:scale-105">
                    <h1 className="text-5xl md:text-6xl font-extrabold text-falcons-red mb-8 text-center uppercase drop-shadow-md tracking-wide">
                        Disclaimer
                    </h1>
                    <p className="text-lg md:text-xl leading-relaxed text-gray-300 text-justify md:text-left tracking-wider">
                    ...
                    <p className="text-lg md:text-xl leading-relaxed text-gray-300 mt-6 text-justify md:text-left tracking-wider">
                    ...
                    <div className="mt-10 text-center">
                        <Link href="/" passHref>
                            <span className="inline-block bg-falcons-red text-white text-lg md:text-xl font-bold py-3 px-10 md:px-12 rounded-full shadow-lg hover:bg-red-700 hover:text-yellow-300 transform hover:scale-110 transition-transform duration-300 ease-in-out">
                                Back to Home
                            </span>
                        </Link>
                    </div>
