        ...
        <Layout>
            <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-black to-red-900 text-zinc-100 px-4 md:px-6 pt-10 md:pt-16 relative overflow-hidden">
                ...
                <div className="container mx-auto py-6 md:py-10 relative z-10">
                    <motion.h1
                        className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-center text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 uppercase mb-8 tracking-wider"
                    ...
                    >
                        {Object.keys(endpoints).map((sportKey) => {
                            ...
                            return (
                                <motion.button
                                    key={sportKey}
                                    className={`text-sm sm:text-lg font-bold uppercase tracking-wide px-4 py-2 sm:px-6 sm:py-3 rounded-lg shadow-lg transition-all duration-300 flex items-center ${activeSport === sportKey
                    ...
                    {loading ? (
                        ...
                        >
                            {/* Scores Section */}
                            <motion.div
                                className="bg-gradient-to-br from-zinc-900 to-black rounded-2xl shadow-2xl p-6 sm:p-8 border border-red-700"
                                whileHover={{ scale: 1.02 }}
                                transition={{ duration: 0.2 }}
                            >
                                <h2 className="text-2xl sm:text-3xl font-bold text-orange-500 mb-4 tracking-wide flex items-center">
                                        ...
                                        scores.map((game, index) => (
                                            ...
                                            >
                                                <div className="flex justify-between items-center">
                                                    <p className="text-xl text-zinc-100 font-semibold tracking-wider">
                                                        {game.shortName}
                                                    </p>
                                    ...
                                    {news.length > 0 ? (
                                        news.map((article, index) => (
                                            ...
                                            >
                                                ...
                                                <p className="text-sm text-zinc-400 mt-2">{article.description}</p>
                                            </motion.div>
                                        ))
                                    ) : (
