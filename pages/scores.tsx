...
export default function ScoresPage() {
    ...
    return (
        <Layout>
            <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900 text-white px-4 md:px-6 pt-10 md:pt-16">
                <div className="container mx-auto py-6 md:py-10">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-center text-blue-500 uppercase mb-8 tracking-wider">
                    ...
                    <div className="flex justify-center space-x-2 sm:space-x-4 mb-6 sm:mb-8">
                        {Object.keys(endpoints).map((sportKey) => (
                            <button
                                key={sportKey}
                                className={`text-sm sm:text-lg font-bold uppercase tracking-wide px-4 py-2 sm:px-6 sm:py-3 rounded-lg shadow-lg transition-all duration-300 transform hover:scale-105 ${activeSport === sportKey
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                            {/* Scores Section */}
                            <div className="bg-gray-800 rounded-2xl shadow-2xl p-6 sm:p-8 transition-transform hover:scale-105">
                                <h2 className="text-2xl sm:text-3xl font-bold text-blue-500 mb-4 tracking-wide">
                                    Latest Scores
                                </h2>
                                {scores.length > 0 ? (
                                    ...
                                    news.map((article, index) => (
                                        <div key={index} className="mb-6 border-b border-gray-600 pb-4">
                                            <a
                                                ...
                                                className="text-lg text-blue-500 font-bold hover:underline tracking-wider"
                                                target="_blank"
