        ...
        <Layout>
            <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-falcons-red text-white px-4 md:px-6 pt-10 md:pt-16">
                <div className="container mx-auto py-6 md:py-10">
                    <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-center text-falcons-red uppercase mb-8 tracking-wider">
                                    ...
                                    scores.map((game, index) => (
                                        <div key={index} className="mb-6 border-b border-gray-600 pb-4">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <p className="text-lg sm:text-xl text-falcons-red font-bold">
