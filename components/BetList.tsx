    ...
    return (
        <div className="space-y-8 max-w-4xl mx-auto p-4 md:p-8">
            {bets.map((bet) => (
                <motion.div
                    key={bet.id}
                    className="relative bg-gradient-to-br from-gray-900 to-black p-6 md:p-8 rounded-xl shadow-2xl transition-all duration-300 hover:shadow-red-900/50 text-white overflow-hidden"
                ...
                >
                    ...
                    <div className="absolute inset-0 z-0">
                        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-red-900 to-gray-900 opacity-20"></div>
                        <div className="absolute top-0 left-0 w-1/3 h-full bg-gradient-to-br from-red-700 to-red-900 opacity-10 transform -skew-x-12"></div>
                    </div>
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center mb-6 space-y-4 md:space-y-0">
                        <div>
                            <h2 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-700 mb-1 uppercase tracking-wide">{bet.team}</h2>
                            <p className="text-base text-gray-400">vs {bet.opponent}</p>
                        </div>
                        <div className="text-right">
                            <p className="text-lg font-bold text-gray-300">Bet Type: <span className="text-red-400">{bet.betType}</span></p>
